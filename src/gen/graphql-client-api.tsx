...
export type DeleteOrnerMutation = { __typename?: "Mutation" } & {
  deleteOrner: { __typename?: "ReturnDelete" } & Pick<ReturnDelete, "id">;
};
...
export type DeletePostMutation = { __typename?: "Mutation" } & {
  deletePost: { __typename?: "ReturnDelete" } & Pick<ReturnDelete, "id">;
};
...
export type DeleteUserMutation = { __typename?: "Mutation" } & {
  deleteUser: { __typename?: "ReturnDelete" } & Pick<ReturnDelete, "id">;
};
...
export type UpdateUserMutation = { __typename?: "Mutation" } & {
  updateUser: { __typename?: "User" } & Pick<
    User,
    "id" | "creationDate" | "lastModifiedDate" | "email" | "role"
  >;
};
...
`;
export type DeleteOrnerMutationFn = ApolloReactCommon.MutationFunction<
  DeleteOrnerMutation,
 ...
 * });
 */
export function useDeleteOrnerMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteOrnerMutation,
    DeleteOrnerMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteOrnerMutation,
    DeleteOrnerMutationVariables
  >(DeleteOrnerDocument, baseOptions);
}
export type DeleteOrnerMutationHookResult = ReturnType<
  typeof useDeleteOrnerMutation
>;
export type DeleteOrnerMutationResult = ApolloReactCommon.MutationResult<
  DeleteOrnerMutation
>;
export type DeleteOrnerMutationOptions = ApolloReactCommon.BaseMutationOptions<
  DeleteOrnerMutation,
  DeleteOrnerMutationVariables
>;
...
export function useMyInfoQuery(
  ...
  return ApolloReactHooks.useQuery<MyInfoQuery, MyInfoQueryVariables>(
    MyInfoDocument,
    baseOptions
  );
}
export function useMyInfoLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<MyInfoQuery, MyInfoQueryVariables>(
    MyInfoDocument,
    baseOptions
  );
}
...
export type MyInfoQueryResult = ApolloReactCommon.QueryResult<
  MyInfoQuery,
  MyInfoQueryVariables
>;
